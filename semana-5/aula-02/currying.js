//CURRYING
//Transforma f(a, b) em f(a)(b), permitindo fixar parâmetros
//e reaproveitar a função já configurada.
...
//EXEMPLO PRÁTICO: taxa de frete por região
...
//COMPOSIÇÃO
//Encadeia funções pequenas para formar uma transformação maior:
//o resultado de uma alimenta a próxima, como uma linha de montagem.
...
/**
 * A regra do cálculo foi escrita UMA vez.
 * As três taxas não são três funções copiadas com números diferentes:
 * são três configurações da mesma função.
 */
